CREATE DATABASE  IF NOT EXISTS `fraternitas` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fraternitas`;
-- MySQL dump 10.13  Distrib 8.0.32, for Win64 (x86_64)
--
-- Host: localhost    Database: fraternitas
-- ------------------------------------------------------
...
INSERT INTO `cliente` VALUES (1,'23231212','Ana','Maria','F','ddd@gamila','3030030','34','223','33','33',1),(2,NULL,'Joaquim','Hangalo','joajoshang@gmail.com','M','3351641820','1212','1212','1212','1212',3),(3,NULL,'Joaquim','Hangalo','joajoshang@gmail.com','M','3351641820','1212','1212','1212','1212',3),(4,NULL,'Vários','Vários','','M','','','','','',95),(5,NULL,'Vários','Vários','','M','','','','','',95);
...
INSERT INTO `familia_do_produto` VALUES (1,'Padaria'),(2,'Confeitaria'),(3,'Bebidas'),(4,'Salgados'),(5,'Doces'),(6,'Paracuca'),(7,'Hambúrguer');
...
INSERT INTO `forma_de_pagamento` VALUES (1,'Cash'),(2,'TPA'),(3,'Banco');
...
INSERT INTO `produto` VALUES (7,'Coca Cola em bidon','2023-09-11',400,24,'prateleira',5,7),(8,'Gasosa Zipp','2023-09-11',250,48,'prateleira',5,7),(9,'Speed 330ml','2023-09-11',350,12,'prateleira',5,7),(10,'Pepsi-Cola','2023-09-11',250,24,'prateleira',5,8),(11,'Sumo Kyfresco - Palinha','2023-09-11',150,20,'prateleira',5,6),(12,'Água pequena Atlático','2023-09-11',100,100,'prateleira',6,7),(13,'Água Média Pura','2023-09-11',150,24,'prateleira',6,7),(14,'Sumo Lulu - Palinha','2023-09-11',150,27,'prateleira',5,7),(15,'Sumo Canajoy','2023-09-11',200,24,'prateleira',5,7),(16,'Bolacha Renata - Doce','2023-09-11',400,18,'prateleira',4,6),(17,'Bolacha Triunfo -Salgada','2023-09-11',500,16,'prateleira',4,6),(18,'Bolacha Betina -Doce','2023-09-11',100,48,'prateleira',4,6),(19,'Bolacha Laykon - Salgada','2023-09-11',100,24,'prateleira',4,6),(20,'Sambapito Yoguera','2023-09-11',50,48,'prateleira',7,6),(21,'Pastilha Gorila','2023-09-11',50,100,'prateleira',7,6),(22,'Batata Piki Nik','2023-09-11',40,50,'prateleira',8,6);
...
INSERT INTO `tipo_de_produto` VALUES (1,'Pães',1),(2,'Bolos',1),(3,'Bolinhos Secos',1),(4,'Bolachas e biscoitos',2),(5,'Sumos e refrigerantes',3),(6,'Águas',3),(7,'Rebuçados, Gomas e Pastilhas',5),(8,'Batata frita',4);
...
INSERT INTO `unidade_de_medida` VALUES (1,'Caixa'),(2,'Garrafa'),(3,'Saco'),(4,'Grama'),(5,'Quilo'),(6,'Pacote'),(7,'Bidon'),(8,'Latinha');
...
-- Dump completed on 2023-09-11  9:05:33
